  ...
  return (
    ...
    >
      ...
      <div className="mt-9 flex flex-wrap justify-center gap-3">
        ...
        <a
          href="#how"
          className="inline-flex items-center rounded-none border border-white/20 px-6 py-3.5 text-[15px] font-semibold text-white transition-colors hover:border-white/45"
        >
          Read the docs
        </a>
      </div>
